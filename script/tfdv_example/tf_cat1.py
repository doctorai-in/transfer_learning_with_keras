...
_URL = ("gs://kubeflow-test-288607-kubeflowpipelines-default/transfer-learning-keras-training/data/raw_data")
...
class production_data(tfds.core.GeneratorBasedBuilder):
  """Cats vs Dogs."""
